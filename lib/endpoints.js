const URLS = {
    ...
    clusterroles: 'https://$ENDPOINT/apis/authorization.openshift.io/v1/clusterroles',
    sa:           'https://$ENDPOINT/api/v1/namespaces/$NAMESPACE/serviceaccounts',
    crb:          'https://$ENDPOINT/apis/authorization.openshift.io/v1/clusterrolebindings',
    rolebindings: 'https://$ENDPOINT/apis/authorization.openshift.io/v1/rolebindings',
    roles:        'https://$ENDPOINT/apis/authorization.openshift.io/v1/roles',
}
